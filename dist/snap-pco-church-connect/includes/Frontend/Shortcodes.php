<?php
namespace SnapChurchConnect\PCO\Frontend;
...
class Shortcodes {
	...
	public function render_events($atts) {
		wp_enqueue_style('snap-pco-church-connect-frontend');
		...
		if (! $query->have_posts()) {
			return '<div class="church-connect-events church-connect-events--empty">' . esc_html__('No upcoming events found.', 'snap-pco-church-connect') . '</div>';
		}
